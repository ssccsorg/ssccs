...
For foundational details, see [Core Concept](/guide.html), [Schema–Segment Composition Computing System](/whitepaper/whitepaper.html), [A Foundation for Energy-Efficient and Trustworthy Computing](/partnerships/proposal.html), and [Philosophy](/philosophy).
