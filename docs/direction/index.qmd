...
### Prevention of Show-off and Exploitation

To those who invest in this foundation, the terms are plain: no glossy landing page, no staged performance, no narrative built to be sold. You invest in the work itself, the daily pursuit of a new computing paradigm while academia and large capital dismiss it; the driving force is the work, not the founder. We take none of the logic by which capital profits at the expense of founders: no valuation theatre, no engineered scarcity, no growth narrative. What counts is what runs: an open artifact, a measured result, a system in use.
