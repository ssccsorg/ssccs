...
SSCCS treats computation as the observation of stationary structure; the full declaration lives in the [Axioms](/axioms/), with the formal model in the [whitepaper](/whitepaper/whitepaper.html), the proposal in [A Foundation for Energy-Efficient and Trustworthy Computing](/partnerships/proposal.html), and the deeper stance in [Philosophy](/philosophy).
