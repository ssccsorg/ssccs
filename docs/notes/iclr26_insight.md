...
| 10 | (정보 없음). (2026). Delta‑State Algebra: A Formally Verified Foundation for Transient State Computation. ICLR 2026. | (링크 확인 불가) |
...
| 17 | (Anonymous). (2026). AgentFlow: In‑the‑Flow Agentic System Optimization for Effective Planning and Tool Use. ICLR 2026. | [OpenReview](https://openreview.net/forum?id=AF26_IFASO), [GitHub](https://github.com/OpenDCAI/AgentFlow) |
