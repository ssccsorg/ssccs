...
The same structural pattern, an index-table lookup replaced by a closed form, was measured end to end in the CERN ROOT-Bypass work on a production CMS dataset (69.0x coordinate, 181.7x mapped). Those numbers are the measured result of that workload; they do not project a vLLM speedup.
