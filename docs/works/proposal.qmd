...
- **Legal Structure:** Pre-incorporation; transitioning to an **open-core model** (an open-source foundation for the core and a commercial entity for proprietary IP).
- **Operating Principle:** Parallel execution of high-level research, low-level implementation, and global partnership.
- **Published Foundation:** The whitepaper (DOI: 10.5281/zenodo.18759106) is followed by topic papers on CERN's Zenodo: Tagma (DOI: 10.5281/zenodo.21302508), Tagma Identification, and Tagma Map (DOI: 10.5281/zenodo.21499437), each with an open-source reference implementation and measured benchmarks.
