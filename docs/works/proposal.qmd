...
- **Published Foundation:** The whitepaper (DOI: 10.5281/zenodo.18759106) is followed by topic papers on CERN's Zenodo: Tagma (DOI: 10.5281/zenodo.21302508), Tagma Identification, and Tagma KV (DOI: 10.5281/zenodo.21499437), each with an open-source reference implementation and measured benchmarks.
