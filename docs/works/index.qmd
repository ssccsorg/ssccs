...
title_meta_items = {
    "html": [
        {"title": "Message Us", "link": "mailto:co@ssccs.org", "content": "co@ssccs.org", "icon": "bi bi-envelope"},
    ],
}
```
...
Engagements begin with a concrete problem. If your institution or startup portfolio faces workloads where data movement, verification, or I/O dominates the cost, the starting point is the [A Foundation for Energy-Efficient and Trustworthy Computing](/works/proposal.html).
