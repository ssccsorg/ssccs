...
title_meta_items = {
    "html": [
        ...
        {"title": "Whitepaper", "link": "https://docs.ssccs.org/whitepaper/whitepaper.html", "content": "SSCCS", "icon": "bi bi-link"},
        {"title": "Whitepaper", "link": "https://docs.ssccs.org/projects/syntagma/tagma", "content": "Tagma", "icon": "bi bi-link"},
        {"title": "Tech report", "link": "root-ttree", "content": "ROOT-TTree I/O", "icon": "bi bi-link"},
        {"title": "Community", "link": "https://root-forum.cern.ch/t/replacing-ttree-i-o-traversal-with-arithmetic-a-coordinate-indexed-read-path-for-cms-open-data/", "content": "ROOT", "icon": "bi bi-link"},
    ],
}
```
...
We propose a bounded demonstration on CMS Open Data (MiniAOD) that reproduces the access pattern and reports the comparison against the ROOT baseline. The collaboration would start from a working result, demonstrated on CERN's own access pattern without disturbing the production ecosystem.
