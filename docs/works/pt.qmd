...
format:
  beamer:
    ...
    include-in-header:
        text: |
            \IfFileExists{./_files/pt_metadata.tex}{\input{./_files/pt_metadata.tex}}{\GenericWarning{}{Metadata: no generated file is present, so the version stamp and the affiliation values are empty. Run 'sdb pre .' to write them.}\providecommand{\version}{}}
...
- **Open proposal document**: [docs.ssccs.org/works/proposal.html](https://docs.ssccs.org/works/proposal.html)
