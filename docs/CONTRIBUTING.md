...
- For documentation contributions, a DevContainer configuration is provided to ensure a consistent build environment; see [.devcontainer/README.md](/.devcontainer/README.md).
