...
- For documentation contributions, a DevContainer configuration is provided to ensure a consistent build environment; see [.devcontainer/README.md](docs/.devcontainer/README.md).
