...
- **Proposal**: A companion document focusing on practical implementation and sustainability.
- **Legal documents**: The foundation's charter and statutes.
- **Research notes**: Informal technical explorations.

All documents are authored in Quarto (`.qmd`) and can be rendered to PDF, HTML, and Markdown using the centralized build script `docs/build.py`. This script handles Quarto rendering, C2PA signing (for PDFs), and copying outputs to the appropriate locations.
