...
[The Proposal](https://ssccsorg.github.io/ssccs/proposal) outlines a foundation for energy‑efficient, verifiable computing, detailing the technical roadmap and architectural decisions. It serves as a companion document to the Whitepaper, focusing on practical implementation and sustainability.
...
The Whitepaper and Proposal are built with Quarto and signed with C2PA. See [docs/whitepaper/README.md](docs/whitepaper/README.md) for full
