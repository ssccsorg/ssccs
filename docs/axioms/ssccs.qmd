  ...
  pdf:
    ...
    include-in-header:
      text: |
        ...
        \IfFileExists{./_files/_metadata.tex}{\input{./_files/_metadata.tex}}{\GenericWarning{}{Metadata: no generated file is present, so the version stamp and the affiliation values are empty. Run 'sdb pre .' to write them.}\providecommand{\authoremail}{}\providecommand{\authorrole}{}}
...
- Whitepaper: [HTML](https://docs.ssccs.org/whitepaper/whitepaper.html) / [PDF](https://docs.ssccs.org/whitepaper/whitepaper.pdf) — DOI: [10.5281/zenodo.18759106](https://doi.org/10.5281/zenodo.18759106) via CERN/Zenodo, indexed by OpenAIRE. Licensed under *CC BY-NC 4.0*.
