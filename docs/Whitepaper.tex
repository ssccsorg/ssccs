...
wall'' {[}1, 2, 3{]}. While new hardware-side paradigms attempt to
mitigate this, it remains a localized optimization within the same
sequential paradigm.
...
As demonstrated in the emergence of State-Space Models (SSMs) \([6]\)
and manifold-constrained learning \([5]\), the ability to process
...
\item
  ...
  \emph{Manifold-Constrained Hyper-Connections} by DeepSeek {[}5{]}
...
\item
  ...
  and hardware-aware frameworks such as Modular AI's MAX/Mojo {[}7,
  8{]}. While these systems achieve high-performance linear recurrences
...
\item
  ...
  \emph{Communications of the ACM}, vol.~54, no. 5, pp.~67--77, 2011.
\item
...
\item
  ...
  about it),'' in \emph{IEEE International Solid-State Circuits
  Conference}, 2014.
\item
  {[}5{]} DeepSeek-AI. (2025). \emph{mHC: Manifold-Constrained
  Hyper-Connections}. arXiv preprint arXiv:2512.24880.
  https://arxiv.org/abs/2512.24880
\item
  {[}6{]} A. Gu and T. Dao, ``Mamba: Linear-Time Sequence Modeling with
  Selective State Spaces,'' \emph{arXiv preprint arXiv:2312.00752},
  2023.
\item
  {[}7{]} Modular AI, ``MAX: A Unified AI Execution Engine,''
  {[}Online{]}. Available: https://www.modular.com/max. Accessed
  Feb.~2026.
\item
  {[}8{]} C. Lattner et al., ``Mojo: Programming Language for All of
  AI,'' {[}Online{]}. Available: https://www.modular.com/mojo. Accessed
  Feb.~2026.
\end{itemize}
...
\begin{flushright}
    ...
    \hspace{10pt}
    \includegraphics[height=50pt]{Whitepaper_files/image1.pdf}
\end{flushright}
