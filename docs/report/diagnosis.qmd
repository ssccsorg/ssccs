---
title: "Diagnosis Report: Technical Assessment & Strategic Roadmap"
date: last-modified
colorlinks: true
format:
  html:
  ...
  pdf:
    ...
    include-in-header:
      text: |
        \input{./_files/diagnosis_metadata.tex}        
...
#| echo: false
#| include: false
%run ../_include/_generate_metadata_tex.py --output ./_files/diagnosis_metadata.tex --version_prefix 1.0 --version_mark
...
title_meta_items = {
  "pdf": [
      ...
      {"title": "Other Formats", "link": "https://docs.ssccs.org/report", "content": "HTML"},
      {"title": "Repository", "link": "https://github.com/ssccsorg/ssccs", "content": "GitHub"},
      {"title": "Last Updated", "link": "https://github.com/ssccsorg/ssccs/commits/main/", "content": datestr},
  ],
  "html": [
      {"title": "Other Formats", "link": "https://docs.ssccs.org/report/diagnosis.pdf", "content": "PDF", "content_class": "bi bi-file-pdf"},
      {"title": "Repository", "link": "https://github.com/ssccsorg/ssccs", "content": "GitHub"},
  ]
}
```
