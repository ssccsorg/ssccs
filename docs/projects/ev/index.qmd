...
exploration follows the same F-I-H cycle that governs every neXus entity: domain expansion is
...
data exchange between tools; it is a single F-I-H graph to which every instance contributes
