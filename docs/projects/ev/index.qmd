...
ExaVerif is distributed under an open‑core model. The CLI is open‑source (MIT) and free to use. Paid tiers provide advanced interpretation, collaboration features, and formal certification.

| Tier | Price | Scope |
|:---|:---|:---|
| **ExaVerif CLI** | Free (MIT) | `ExaVerif check` — basic composition and evaluation |
