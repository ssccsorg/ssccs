...
Every result is also available as structured JSON for downstream consumption by [Nexus](https://docs.ssccs.org/projects/nexus) — each combination becomes a Fact, each constraint a Hint, and the verification run itself an Intent.
