...
title_meta_items = {
    "html": [
        ...
        {"title": "Whitepapers", "link": "https://doi.org/10.5281/zenodo.21499437", "content": "Tagma-KV", "icon": "bi bi-link"},
...
| [Tagma-KV](/projects/syntagma/tagma/kv) | Hashless Key-Value Storage (CoordSpace type paper) |
| [Tagma-Geo](/projects/syntagma/tagma/geo) | Spatial Query Layer on Structural Coordinate Spaces (CoordCube type paper) |
| [Tagma-ID](/projects/syntagma/identification) | Content-addressable identity without hash functions (application domain) |
| [Tagma-Sec](/projects/syntagma/security) | Integrity, authorization, audit, and non-repudiation on a structural coordinate space (application domain) |
| [Tagma-Signal](/projects/syntagma/signal) | Structural coordinate transmission: the coordinate is the message (application domain) |
| [Tagma-Hardware](/projects/syntagma/hardware) | Hardware implementation of the Tagma primitive: RTL, synthesis, FPGA demo, chton SRAM |
| [Tagma-Memory](/projects/syntagma/hardware/memory) | Three-dimensional SRAM decode and the chton SRAM segment store |
| Tagma-Vec *(forthcoming)* | Vector processing over structural coordinates |
