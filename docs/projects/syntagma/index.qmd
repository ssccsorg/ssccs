...
title_meta_items = {
    "html": [
        ...
        {"title": "References", "link": "/projects/syntagma/tagma/hardware/", "content": "Hardware", "icon": "bi bi-link"},
...
| [TagmaMatrix](/projects/syntagma/tagma/matrix) | Coordinate-addressed rank-2 matrices, the integer product, and the wire form (Matrix type paper) |
| [Serialization](/projects/syntagma/tagma/serialization) | Base11172: human-readable, self-validating serialization |
| [Identification](/projects/syntagma/tagma/identification) | Content-addressable identity without hash functions (application domain) |
| [Security](/projects/syntagma/tagma/security) | Integrity, authorization, audit, and non-repudiation on a structural coordinate space (application domain) |
| [Signal](/projects/syntagma/tagma/signal) | Structural coordinate transmission: the coordinate is the message (application domain) |
| [Hardware](/projects/syntagma/tagma/hardware) | Hardware implementation of the Tagma primitive: RTL, synthesis, FPGA demo, chton SRAM |
| [Memory](/projects/syntagma/tagma/hardware/memory) | Three-dimensional SRAM decode and the chton SRAM segment store |
