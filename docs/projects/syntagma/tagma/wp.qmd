...
| Storage view | Query view | Operation | Cost | Scaling |
|-------------|-----------|-----------|------|---------|
| Dense (CoordSpace) | CoordPath | Single element access | 0.39 ns | O(1) flat |
| Tree (CoordSpaceN) | CoordPath | Single element access | 2.69-58.6 ns | O(N) linear |
| Tree (CoordSpaceN) | CoordCube | Proximity r=1 (9 paths) | 93 ns | 96 Melem/s |
| Tree (CoordSpaceN) | CoordCube | Proximity r=5 (121 paths) | 343 ns | 353 Melem/s |
| Tree (CoordSpaceN) | CoordCube | Bounding box 10K paths | 14.6 µs | 699 Melem/s |
