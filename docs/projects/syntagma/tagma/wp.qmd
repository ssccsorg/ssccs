...
- **Spatial query — two tiers**: (a) CoordSet bitwise AND resolves compound axis filters at 329 Melem/s -- 150x faster than HashMap scan. (b) **CoordCube on CoordSpaceN tree** generates proximity regions at 96-353 Melem/s and bounding boxes at 699 Melem/s, achieving near-native throughput despite tree traversal — the tree fallback becomes a spatial query engine with only ~60 ns overhead above the baseline.
