...
| Operation | CoordPath | CoordCube | Ratio |
|-----------|-----------|-----------|-------|
| Single element access | 0.39 ns (direct index) | N/A | — |
| Region enumeration (9 paths) | N/A (requires 9 separate lookups) | 93 ns (proximity r=1) | — |
| Region enumeration (121 paths) | N/A | 343 ns (proximity r=5) | — |
| Distance measurement | 322 ps (Coord hamming) | 316-322 ps (cube hamming/euclidean/manhattan) | ~1x |
| Bounding box 10K paths | N/A (requires full table scan) | 14.6 µs (699 Melem/s) | — |
