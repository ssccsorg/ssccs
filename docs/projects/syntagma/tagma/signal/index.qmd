...
version-prefix: tagma-signal-draft
version-mark: true
...
1. **Message → coordinate path**: The message is mapped to a sequence of coordinates using the same deterministic transformation as Tagma-KV. Each coord carries log₂(11,172) ≈ 13.45 bits of information, so the mapping is injective for messages up to 13.45N bits (⌊1.68N⌋ bytes) — the information-theoretic bound of an N-coord coordinate path.
