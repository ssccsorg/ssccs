...
|-----------|--------|-------|--------|
| decode | `tagma_decoder` | 16-bit code point | three axes, `valid` |
| compose | `tagma_compose` | three 5-bit axes | 14-bit coordinate index, `valid` |
| distance | `tagma_dist` | two 16-bit code points | three 5-bit distances |
