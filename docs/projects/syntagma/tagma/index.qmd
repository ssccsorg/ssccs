...
| Property | Value |
|----------|-------|
| Coordinate space | 19 (Axis 0)[^char-axis] x 21 (Axis 1) x 28 (Axis 2) = **11,172** valid 16-bit values |
...
For larger identifier spaces, Coords compose linearly. Each Coord adds a factor of 11,172 to the addressable space:

| Coords | Addressable identifiers | Equivalent to |
|-----------|------------------------|---------------|
...
[^char-axis]: The constants 19, 21, and 28 derive from the compositional writing system for which the Unicode block U+AC00–U+D7AF was originally allocated.
