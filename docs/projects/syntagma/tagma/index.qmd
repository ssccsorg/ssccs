...
## Tagma Map[^tagma-kv]: Key-Value Store on Coordinate Primitives {#sec-appendix-tagma-map}
...
whitepaper; the reference implementation lives in `sw/rust/map`[^tagma-kv-src].
...
[^tagma-kv]: Tagma Map whitepaper (DOI: [10.5281/zenodo.21550431](https://doi.org/10.5281/zenodo.21550431)): <https://docs.ssccs.org/projects/syntagma/tagma/map>
...
[^tagma-kv-src]: Tagma Map reference implementation: <https://github.com/ssccsorg/syntagma/tree/main/sw/rust/map>
