...
Code-level analysis of all types -- including `Coord` bit layout, `CoordSpace` inline array with niche optimization, `CoordSet` bit iteration with `trailing_zeros`, and `CoordSpaceN` sparse tree with lazy node allocation -- is in the reference implementation report [Reference Implementation](/projects/syntagma/tagma/impl.html).
...
[^tagma-sec]: Tagma-Sec whitepaper: <https://docs.ssccs.org/projects/syntagma/security>
[^tagma-spec]: Tagma Security Layer Specification: <https://github.com/ssccsorg/syntagma/blob/main/docs/spec/tagma-sec.md>
[^tagma-swref]: Tagma Software Reference Implementation in Rust: <https://docs.ssccs.org/projects/syntagma/tagma/impl.html>
