...
The full design, benchmark charts, and implementation status are described in the Tagma Security whitepaper[^tagma-sec] and in the Tagma security layer specification[^tagma-spec] in the synTagma repository.
...
[^tagma-repo]: Repository: [Github (Pre-release, Apache 2.0)](https://github.com/ssccsorg/syntagma), Benchmark <https://github.com/ssccsorg/syntagma/blob/main/sw/rust/benches/bench.rs>
[^tagma-hw]: Tagma hardware series: <https://docs.ssccs.org/projects/syntagma/hardware/>
[^tagma-map]: TagmaMap whitepaper (DOI: [10.5281/zenodo.21550431](https://doi.org/10.5281/zenodo.21550431)): <https://docs.ssccs.org/projects/syntagma/tagma/map>
[^tagma-geo]: TagmaGeo whitepaper (draft): <https://docs.ssccs.org/projects/syntagma/tagma/geo>
[^tagma-geo-src]: TagmaGeo reference implementation: <https://github.com/ssccsorg/syntagma/tree/main/sw/rust/geo>
[^tagma-map-src]: TagmaMap reference implementation: <https://github.com/ssccsorg/syntagma/tree/main/sw/rust/map>
[^tagma-sec]: Tagma Security whitepaper: <https://docs.ssccs.org/projects/syntagma/security>
[^tagma-spec]: Tagma Security Layer Specification: <https://github.com/ssccsorg/syntagma/blob/main/docs/spec/tagma-sec.md>
[^tagma-swref]: Tagma Reference Implementations: <https://docs.ssccs.org/projects/syntagma/impl>
