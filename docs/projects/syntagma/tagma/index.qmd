...
## Tagma Map[^tagma-map]: Key-Value Store on Coordinate Primitives {#sec-appendix-tagma-map}

Tagma Map builds a practical key-value storage engine on top of
...
Tagma Map extends the model to handle legacy infrastructure requirements that
...
range partitioning. Tagma Map supplies what the coordinate model intentionally
abstracts away: durable storage, wire protocols, and cluster management.

The full design and benchmark results are described in the Tagma Map
...
[^tagma-map]: Tagma Map whitepaper (DOI: [10.5281/zenodo.21550431](https://doi.org/10.5281/zenodo.21550431)): <https://docs.ssccs.org/projects/syntagma/tagma/map>
...
[^tagma-map-src]: Tagma Map reference implementation: <https://github.com/ssccsorg/syntagma/tree/main/sw/rust/map>
