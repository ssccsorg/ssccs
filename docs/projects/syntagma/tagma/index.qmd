...
Reproduction: `make -C hw check` runs the whole gate (simulation, synthesis, and equivalence) from a clean checkout of the syntagma repository, and the `hw` CI job runs the same gate. The HDL is licensed under CERN-OHL-P v2; the software reference under `sw/` remains Apache 2.0.
