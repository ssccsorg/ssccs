...
Code-level analysis of all types -- including `Coord` bit layout, `CoordSpace` inline array with niche optimization, `CoordSet` bit iteration with `trailing_zeros`, and `CoordSpaceN` sparse tree with lazy node allocation -- is in the software reference implementation [Reference Implementation](/projects/syntagma/projects/syntagma/impl/sw).
...
|--------|---------|-----------------|-------------------|--------------------|--------------------|---------------------|
| Latency | 227 ns | 0.39 ns | 0.39 ns | 0.40 ns | 5.44 ns | 53.2 ns |
