  ...
  pdf:
    ...
    include-in-header:
      text: |
        ...
        \IfFileExists{./_files/sec_metadata.tex}{\input{./_files/sec_metadata.tex}}{\GenericWarning{}{Metadata: no generated file is present, so the version stamp and the affiliation values are empty. Run 'sdb pre .' to write them.}\providecommand{\affiliationurl}{}\providecommand{\affiliationdomain}{}\providecommand{\authoremail}{}\providecommand{\authorrole}{}}
...
[^spec]: Tagma Security Layer Specification: [github.com/ssccsorg/syntagma/blob/main/docs/spec/tagma-sec.md](https://github.com/ssccsorg/syntagma/blob/main/docs/spec/tagma-sec.md)
