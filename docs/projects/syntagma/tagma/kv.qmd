...
**Remark.** The structural coordinate space that enables this is derived from the Unicode Hangul syllable block. The full specification, including the composition formula and compliance criteria, is defined in the Tagma whitepaper [@tagma-wp].
