...
[^tagma]: Tagma whitepaper: <https://docs.ssccs.org/projects/syntagma/tagma/wp/index.pdf>
...
| HashMap\<String\> | 13.0 ns | 19.9 ns | 26.5 ns |
...
5. **Contains key follows the same pattern**: CoordKV2 is flat at 21.6 ns across all scales. HashMap contains is faster at 10k (13.0 ns, returns bool instead of full value) but rises to 26.5 ns at 10M (+100%). The advantage of returning a bool instead of a value is erased by cache pressure.
