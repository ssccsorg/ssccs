...
synTagma is an open-source project (Apache 2.0) under the SSCCS Foundation, a Swiss open-source association in formation. The Rust reference implementation is available on GitHub with a full benchmark suite and end-to-end verification harness.
