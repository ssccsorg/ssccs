...
- Zed already handles streaming text, tool calls, file edits, terminal execution, git checkpoints, and sub-agent spawning. The bridge only translates between ACP and F-I-H; all complex flow control stays in Zed.
...
4. Agent writes result to the F-I-H blackboard as a Fact with provenance metadata
...
4. All agents write results to the F-I-H blackboard
