...
[acp_nexus.qmd](acp_nexus.html). This document covers the nexus-zed implementation.
...
its ACP surface (talking to Zed) and its F-I-H surface (talking to the neXus blackboard):
...
ACP tool calls have a lifecycle that nexus-zed maps to F-I-H Intent states:
...
### Phase 2: F-I-H blackboard connection
