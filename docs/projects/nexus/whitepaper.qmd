...
[^repo]: neXus reference repository, <https://github.com/ssccsorg/nexus>, Apache License 2.0.
[^nexcalc]: `nex-calc` source, <https://github.com/ssccsorg/nexus/tree/main/apps/nex-calc>
[^synTagma]: synTagma is the coordinate-space stack beneath the fabric: the Tagma whitepaper defines coordinate identity, and the reference implementation lives at <https://docs.ssccs.org/projects/syntagma>
[^chton]: chton is the IO materialization layer: it lands the coordinate space onto physical origins (memory, file, signal, network) and provides the flat key-space IO surface that neXus backends implement; <https://docs.ssccs.org/projects/chton>.
...
[^coord20]: Coord ID 20 migration note, nexus repository, <https://github.com/ssccsorg/nexus/blob/main/docs/2026-08-20-coord-id-20-migration.md>
...
[^bench]: neXus benchmark suite, <https://github.com/ssccsorg/nexus>, benches directory
