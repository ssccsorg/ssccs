...
[^tagma]: synTagma is the coordinate-space primitive behind neXus identity. Repository: [github.com/ssccsorg/syntagma](https://github.com/ssccsorg/syntagma), documentation: [docs.ssccs.org/projects/syntagma/](https://docs.ssccs.org/projects/syntagma/)
[^bench]: Benchmark code: [github.com/ssccsorg/nexus/blob/main/benches/bench.rs](https://github.com/ssccsorg/nexus/blob/main/benches/bench.rs)
[^old]: Pre-Tagma baseline from the full-scan implementation, measured on the same Apple M1. Devlog 160: [github.com/ssccsorg/nexus/blob/main/docs/2026-07-29-160-syntagma-integration.md](https://github.com/ssccsorg/nexus/blob/main/docs/2026-07-29-160-syntagma-integration.md)
...
[^flat]: Multi-dimensional search benchmark, issue 179: [github.com/ssccsorg/nexus/issues/179](https://github.com/ssccsorg/nexus/issues/179); devlog 179 in the nexus repository docs folder.
