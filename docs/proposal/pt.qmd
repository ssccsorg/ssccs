...
- **Full proposal document**: [docs.ssccs.org/proposal](https://ssccs.org/proposal)
- **A Comprehensive Guide of Core Concepts**: [ssccs.org/guide](https://ssccs.org/guide)

<br /><br />

### How it started: Background

While the industry races to build bigger hardware, SSCCS began from a time-series interpreation project on preserving structure in chaotic high‑dimensional data forced us to rethink computation itself: **Without a new software philosophy, even the best hardware hits a wall.**

---

## The Problem We Face: Data movement dominates energy
...
- AI data centers could draw **68 GW by 2027** – nearly **California’s entire grid**, By 2030, data centers may use **9–17% of US power**, with **3–4× server costs**
...
#|   - "Share of US electricity consumption by data centers (EPRI 2026) [@epri2026]."
...
- Documented damage from AI incidents already exceeds **$100 billion**
...
SSCCS (Schema–Segment Composition Computing System) emerged from research on high‑dimensional time‑series data, where preserving structure across chaotic systems forced us to rethink computation.
...
\begin{center}
```
![](../_include/images/ontology.svg){height=70%}
```{=latex}
\end{center}
```
...
- **Scientific computing**: I/O energy and latency eliminated.


## Current Status

| Founder         | Solo, Berlin-based                          |
|-----------------|---------------------------------------------|
| Legal           | Non-profit (in preparation), global scope   |
| Project         | Long-term research + technical validation   |
| Initial         | Whitepaper on CERN/Zenodo                   |
| PoC             | Rust – early primitives in progress         |
| Research        | Topic papers → insights feed back to core   |
| Partners        | EU, South Korea, any aligned public-interest|
