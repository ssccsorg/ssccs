...
%run ../_include/_generate_metadata_tex.py --output ./_include/pt_metadata.tex --version_prefix 1.0
```
...
A determistic computing model-based software compiler infrastructure by geometrically arranging data and observing structure under dynamic constraints without moving it.
