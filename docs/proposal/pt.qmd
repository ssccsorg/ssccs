...
subtitle: "SSCCS: Schema–Segment Composition Computing System"
    ...
    include-in-header:
        text: |
            \setbeamertemplate{title page}{
                ...
                \vskip1.5em
                \input{./_include/pt_metadata.tex}
...
%run ../_include/_generate_metadata_tex.py --output ./_include/pt_metadata.tex --version_prefix 1
```
...
A computing model by geometrically arranging data and observing structure under dynamic constraints without moving it.
