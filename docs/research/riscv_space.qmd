...
| Performance | Functional after 100 kRad (proton) TID; no SEFI observed in testing [@elash2025efficacy] |
...
|-------|----------|------------------|------------------------------|
| StarRISC [@elash2025efficacy] | RHBD with hardened flip‑flops + SECDED ECC | Demonstrated functional operation after 100 kRad TID | Ideal target for Field sandboxing via PMP; minimal area overhead for Field accelerator |
