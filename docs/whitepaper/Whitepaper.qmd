      ...
      text: |
        ...
        \def\@maketitle{
          \begin{center}
            ...
            \vspace{4em}
                {\large \@author \thanks{\authorrole; Corresponding author: \href{mailto:\authoremail}{\authoremail}} \par}
                \vspace{0.3em}
                {\normalsize \affiliationname \ | \texttt{\href{\affiliationurl}{\affiliationdomain}} \par}
            \vspace{2em}
                {\normalsize \@date \par}
                \vspace{0.3em}
                {\scriptsize \texttt{\version} \par}
            \vspace{4em}
          \end{center}
        }
        \makeatother
