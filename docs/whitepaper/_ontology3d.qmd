...
# import inspect
# try:
#     current_frame_file = inspect.getfile(inspect.currentframe())
#     qmd_dir = os.path.dirname(os.path.abspath(current_frame_file))
# except Exception:
#     qmd_dir = os.path.dirname(os.path.abspath(os.environ.get('QUARTO_FILE_PATH', os.getcwd())))
# target_json = os.path.join(qmd_dir, "_ontology3d.json")
# pio.write_json(fig, target_json)
```
:::