...
digraph SystemStack {
    ...
    Projector -> Accelerator [label="in-memory observation", style=dashed];

    // Hardware memory access
    CPU -> RAM [label="load/store (minimal)"];
    Accelerator -> RAM [label="direct access"];
    ...
    Compiler -> Accelerator [label="target profile", style=dashed, constraint=false];
}
"""
)
```
