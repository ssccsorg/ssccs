...
title_meta_items = {
   "html": [
      ...
      {"title": "View Slides", "link": "/proposal/pt.pdf", "content": "PDF", "content_class": "bi bi-file-pdf"},
  ]
}
```
...
Future versions of the `.ss` schema may include a `triggers` block inside a Field definition. A possible syntax sketch:
