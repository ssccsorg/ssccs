...
format:
  html:
    ...
    code-overflow: wrap
    include-in-header:
      file: ../_include/default_html_style.html
    format-links: false
    title-meta-extension:
      other-formats:
        pdf: ../whitepaper.pdf
  gfm:
    number-sections: true
        ...
        \def\@maketitle{
          \begin{center}
            ...
            \vspace{4em}
                ...
                \vspace{0.3em}
                {\scriptsize \texttt{\href{\affiliationurl}{\affiliationdomain}} \par}
            \vspace{2em}
                {\normalsize \@date \par}
                \vspace{0.3em}
...
{{< include ../_include/_title_meta_extension.qmd >}}
