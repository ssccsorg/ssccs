...
Relations replace traditional control flow (loops, conditionals) with a static description of connectivity and proximity.
...
This content‑based addressing ensures that the same topological blueprint always yields the same cryptographic hash, enabling verification and composition.