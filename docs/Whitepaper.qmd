...
bibliography: _include/whitepaper/references.bib
csl: _include/whitepaper/ieee.csl
link-citations: true
colorlinks: true
format:
  html:
  ...
  pdf:
    ...
    post-render: |
      python3 _utils/sign_c2pa.py --pdf Whitepaper.pdf --manifest Whitepaper.c2pa_manifest.json --output Whitepaper.c2pa
    header-includes:
        - |
            \usepackage{authblk}
...
{{< include _include/whitepaper/_philvis.qmd >}}
...
{{< include _include/whitepaper/_ontology3d.qmd >}}
